    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 pb-24">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 pb-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-blue-100">Track your portfolio</p>
        </div>
      </div>
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-800 dark:text-white">Stocks</span>
              </div>
            ...
            <p className="text-right text-lg font-semibold text-gray-800 dark:text-white">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-800 dark:text-white">Crypto</span>
              </div>
              <span className="text-gray-600 dark:text-gray-400">
